...
export default function registerKnowledgeGraph(app, { sendError }) {
  app.get("/api/knowledge/triplets", { schema: { response: { 200: { type: "object", properties: { triplets: { type: "array", items: { type: "object" } }, count: { type: "number" }, error: { type: "string" } } } } } }, async (req) => {
    try {
  ...
  app.get("/api/knowledge/entity", { schema: { response: { 200: { type: "object", properties: { entity: { type: "object" }, outgoing: { type: "array", items: { type: "object" } }, incoming: { type: "array", items: { type: "object" } }, error: { type: "string" } } } } } }, async (req) => {
    try {
